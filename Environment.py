...
class Environment:
    ...
    def break_walls(self, current_cell:Cell):
        #update the graph, after breaking cells and adding neighbours
        pass
    ...
    def execute_action(self, player1_action: Action, player2_action: Action, player1_error: bool, player2_error: bool):
        ...
        if player1_action.get_action_type() == Action.ATTACK:
            #PLAYER 1 ATTACK
            guardians_present = player1_action.get_target(self.get_graph()).get_guardians_present()
            our_guardian = self.__player1.get_guardian_by_type(player1_action.get_guardian_type())
        ...
        #GENERATE STARLORD FEEDBACK OBJECTS(append to players)and UPDATE GROOT HEALTH
        ...
        #     elif player1_action.get_action_type() == Action.ATTACK:
        #         guardians_present = player1_action.get_target(self.get_graph()).get_guardians_present()
        #         our_guardian = self.__player1.get_guardian_by_type(
        #             player1_action.get_guardian_type())
