...
class State:
    ...
    def json(self):
        ...
        for troop_name, troop in self.__movegen.items():
            ...
            movegen_as_json[troop_name] ={"coordinates": str(self.__player.guardians[troop_name].coordinates), "health": self.__player.guardians[troop_name].health ,"neighbours": neighbours}
        return {
